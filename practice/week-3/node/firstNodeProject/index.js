...
let arrayComined = _.concat(array1, array2);

console.log(arrayComined);
...
3) install the package "Express" locally to this secondNodeProject forlder.
4) Bonus: find out a methor or property you cna use and use it indide of the index.js file.
*/
